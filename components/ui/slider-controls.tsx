  ...
  return (
    ...
    >
      <li className="h-10 w-10 rounded-full bg-gradient-to-b group hover:bg-gradient-to-t from-dark-20 to-dark-20/0 p-px">
        <button className="transition-all duration-300 ease-out inline-grid place-content-center group-hover:shadow-primary group-hover:bg-primary-55 bg-dark-12 h-full w-full rounded-full">
          <ChevronLeft />
        </button>
      </li>
      <li className="h-10 w-10 rounded-full bg-gradient-to-b group hover:bg-gradient-to-t from-dark-20 to-dark-20/0 p-px">
